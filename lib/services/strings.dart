...
/// UI strings. English is the base; Twi, Ewe, Ga, Dagbani and Hausa sit
/// beside each English source below. The style is conservative, code-switched
...
/// Ga is the newest and least reviewed set; check it first. A missing
/// translation falls back to English on purpose rather than guess.
abstract final class S {
  ...
  static String get scanBlurb => _l(
      ...
      ga: 'Kɛ camera lɛ tsɔɔ adeka lɛ nɔ. Obaaná hetoo amrɔ nɔŋŋ.',
  ...
  static String worksOffline(int count, String date) => _l(
      ...
      ga: 'Internet he ehiaaa · FDA wolo mli nibii $count · $date',
  ...
  static String get recentChecks => _l('Recent checks',
      ...
      ha: 'Abin da ka duba');
  static String get seeAll => _l('See all',
      tw: 'Hwɛ ne nyinaa', ee: 'Kpɔ wo katã', ga: 'Kwɛmɔ fɛɛ', ha: 'Duba duka');
  static String get nothingChecked => _l(
      ...
      ga: 'Okwɛko nɔ ko. Kwɛmɔ o-tsofa klɛŋklɛŋ ni hetoo lɛ aaaba biɛ.',
      ha: 'Ba ka duba komai ba tukuna. Duba maganin farko, amsar za ta zo nan.');
  static String get unnamedPack => _l('Unnamed pack',
      tw: 'Adaka a enni din', ga: 'Adeka ni bɛ gbɛi', ha: 'Akwati mara suna');
  static String get justNow => _l('Just now',
      tw: 'Seesei ara', ee: 'Fifi laa', ga: 'Amrɔ nɛɛ', ha: 'Yanzu yanzu');
  static String minAgo(int m) => _l('$m min ago',
      tw: 'Simma $m atwam', ga: 'Minti $m eho', ha: 'Minti $m da suka wuce');
  static String hAgo(int h) => _l('$h h ago',
      tw: 'Nnɔnhwerew $h atwam',
      ga: 'Ŋmɛlɛtswaa $h eho',
      ha: 'Awa $h da suka wuce');
  static String get yesterday => _l('Yesterday',
      tw: 'Nnɛra', ee: 'Etsɔ si va yi', ga: 'Nyɛ', ha: 'Jiya');

  // ── Scan & result ─────────────────────────────────────────────────────
  static String get resultTitle => _l('Result',
      tw: 'Mmuae', ee: 'Ŋuɖoɖo', ga: 'Hetoo', dag: 'Labari', ha: 'Amsa');
  static String get useThisPhoto => _l('Use this photo?',
      tw: 'Fa mfonini yi?',
      ee: 'Zã foto sia?',
      ga: 'Kɛ foto nɛɛ tsu nii?',
      ha: 'A yi amfani da wannan hoto?');
  static String get retake => _l('Retake',
      tw: 'Twa bio', ee: 'Ɖae ake', ga: 'Tswa ekoŋŋ', ha: 'Sake ɗauka');
  static String get checkIt => _l('Check it',
      tw: 'Hwɛ', ee: 'Kpɔe', ga: 'Kwɛmɔ', dag: 'Vihimi', ha: 'Duba shi');
  static String get tryAgain => _l('Try again',
      tw: 'Sɔ hwɛ bio', ee: 'Te ekpɔ ake', ga: 'Ká ekoŋŋ', ha: 'Sake gwadawa');
  static String get scanAgain => _l('Scan again',
      tw: 'Hwɛ bio', ee: 'Kpɔe ake', ga: 'Kwɛmɔ ekoŋŋ', ha: 'Duba kuma');
  static String get scanAnother => _l('Scan another medicine',
      tw: 'Hwɛ aduro foforo',
      ee: 'Kpɔ atike bubu',
      ga: 'Kwɛmɔ tsofa kroko',
      dag: 'Vihimi tim din',
      ha: 'Duba wani magani');
  static String get readingPack => _l('Reading the pack…',
      tw: 'Yɛrekenkan adaka no so…',
      ee: 'Míele aɖaka la xlẽm…',
      ga: 'Miikane adeka lɛ nɔ…',
  ...
  static String get allOnPhone => _l(
      ...
      ga: 'Nɔ fɛɛ nɔ tsuɔ nii yɛ phone nɛɛ nɔ. Internet he ehiaaa.',
  ...
  static String get cameraOff => _l(
      ...
      ga: 'Aŋmɛɛɛ camera lɛ gbɛ. Gbele yɛ Settings mli, loo hala foto ko.',
  ...
  static String get noCamera => _l(
      ...
      ga: 'Camera bɛ phone nɛɛ nɔ. Hala adeka lɛ foto ko.',
  ...
  static String get tipsTitle => _l('Tips for a clear read',
      ...
      ga: 'Nɔ ni obaafee ni anaa jogbaŋŋ',
  ...
  static String get tips => _l(
      ...
      ga: '• Yaa he ni la yɔɔ. Shwane la hi fe fɛɛ.\n'
          '• Ha adeka lɛ hiɛ ayi foto lɛ mli.\n'
          '• Damɔ shi dinn kɛyashi foto lɛ mli atse.',
  ...
  static String get modelNotSetUp => _l(
      ...
      ga: 'Asaako offline model lɛ. Download lɛ yɛ Settings mli, ni okwɛ ekoŋŋ.',
  ...
  static String get somethingWrong => _l(
      ...
      ga: 'Nɔ ko eyako jogbaŋŋ yɛ kwɛmɔ lɛ mli. Ká ekoŋŋ.',
  ...
  static String get vUnreadable => _l('Couldn’t read the pack',
      ...
      ga: 'Anyɛɛɛ adeka lɛ nɔ akane',
      ha: 'Ba a iya karanta akwatin ba');
  static String get vChecked => _l('Checked',
      tw: 'Yɛahwɛ', ee: 'Wokpɔe', ga: 'Akwɛ', ha: 'An duba');
  ...
  static String get rUnreadable => _l(
      ...
      ga: 'Anyɛɛɛ foto lɛ akane. Yaa he ni la yɔɔ ni odamɔ shi dinn.',
  ...
  static String rRecalled(String name) => _l(
      ...
      ga: 'FDA Ghana ewie tsofa nɛɛ he sane: $name.',
  ...
  static String get rRecalledAction => _l(
      ...
      ga: 'Kaanu. Kɛ sane lɛ yaha FDA yɛ 0551112224 (WhatsApp) nɔ, loo okɛ lɛ ku sɛɛ kɛya pharmacy.',
  ...
  static String rExpired(String monthYear) => _l(
      ...
      ga: 'Adeka lɛ tsɔɔ akɛ ebe ji $monthYear. Nakai be lɛ eho.',
  ...
  static String rExpiredButListed(String name) => _l(
      ...
      ga: 'Tsofa lɛ diɛŋtsɛ ($name) yɛ FDA wolo lɛ mli, shi adeka nɛɛ ebe eho.',
  ...
  static String get rExpiredAction => _l(
      ...
      ga: 'Tsofa ni ebe eho lɛ he nyɛɛɛ, loo ebaanyɛ eye bo awui. Kaanu.',
  ...
  static String rFoundAs(String name, String maker) => _l(
      ...
      ga: maker.isEmpty
          ? 'Ana yɛ FDA wolo lɛ mli akɛ “$name”.'
          : 'Ana yɛ FDA wolo lɛ mli akɛ “$name” ni $maker fee.',
      ha: maker.isEmpty
  ...
  static String get rNoExpiryRead => _l(
      ...
      ga: 'Anaaa ebe yɛ adeka lɛ nɔ. Kwɛmɔ bo diɛŋtsɛ dani onu.',
  ...
  static String rCloseName(String read, String listed) => _l(
      ...
      ga: 'Gbɛi ni akane ji “$read”. Ebɛŋkɛ “$listed” ni yɛ FDA wolo lɛ mli, shi ekpãaa gbee pɛpɛɛpɛ.',
  ...
  static String get rSpellingTrick => _l(
      ...
      ga: 'Kwɛmɔ ŋmaa ni yɛ adeka lɛ nɔ lɛ jogbaŋŋ. Gbɛi mli tsakemɔ bibii ji apasa tsofa he okadi.',
  ...
  static String rRegMismatch(String name, String packReg, String listedReg) =>
      _l(
          ...
          ga: 'Gbɛi lɛ kpãa gbee kɛ “$name” ni yɛ FDA wolo lɛ mli, shi adeka lɛ nɔ registration nɔmba ji $packReg; nɔ ni yɛ wolo lɛ mli ji $listedReg.',
  ...
  static String get rRegDriftHint => _l(
      ...
      ga: 'Nɔmbai enyɔ lɛ tamɔ amɛhe waa; ekolɛ camera lɛ tɔ̃ yɛ ŋmaa bibii lɛ kanemɔ mli. Tswa foto lɛ ekoŋŋ yɛ he ni bɛŋ koni ona jogbaŋŋ.',
  ...
  static String get rRegCounterfeitHint => _l(
      ...
      ga: 'Registration nɔmba ni kɛ FDA wolo lɛ mli nɔ̃ lɛ kpãaa gbee ji apasa tsofa he okadi. Ekolɛ hu etsɔɔ akɛ tsofa nɛɛ diɛŋtsɛ registration lɛ eho.',
  ...
  static String get rVerifyFda => _l(
      ...
      ga: 'Bi o-pharmacist loo FDA (0551112224 yɛ WhatsApp nɔ) dani onu.',
  ...
  static String rNotFound(String read) => _l(
      ...
      ga: 'Anaaa “$read” yɛ FDA wolo ni yɛ phone nɛɛ nɔ lɛ mli.',
  ...
  static String get rNotProofFake => _l(
      ...
      ga: 'No etsɔɔɔ akɛ apasa ni, shi kwɛmɔ ohe jogbaŋŋ.',
  ...
  static String get readAloud => _l('Read aloud',
      ...
      dag: 'Karimi ma',
      ha: 'Karanta da murya');
  static String get stopReading => _l('Stop',
      tw: 'Gyae', ee: 'Tɔ', ga: 'Damɔ', dag: 'Chɛli', ha: 'Tsaya');
  ...
  static String get guidanceUnavailable => _l(
      ...
      ga: 'Gbɛtsɔɔmɔ lɛ bɛ amrɔ nɛɛ. Hetoo ni yɛ ŋwɛi lɛ yɛ mli lolo.',
  ...
  static String downloadVoiceHint(String language) => _l(
      ...
      ga: 'Download $language gbee lɛ yɛ Settings mli ni onu.',
  ...
  static String voiceRoadmap(String language) => _l(
      ...
      ga: '$language gbee baaba sɛɛ mli.',
  ...
  static String get answersFromPack => _l(
      ...
      ga: 'Hetooi lɛ jɛɔ nɔ ni adeka lɛ diɛŋtsɛ kɛɔ lɛ pɛ mli.',
  ...
  static String get typeQuestion => _l('Type a question…',
      ...
      ga: 'Ŋmaa sanebimɔ…',
      ha: 'Rubuta tambaya…');
  static String get send => _l('Send', tw: 'Soma', ee: 'Ɖoe ɖa', ha: 'Aika');
  ...
  static String get language => _l('Language',
      tw: 'Kasa', ee: 'Gbe', ga: 'Wiemɔ', dag: 'Yɛltɔɣa', ha: 'Harshe');
  ...
  static String get matchPhone => _l('Match the phone',
      tw: 'Di phone no akyi',
      ee: 'Sɔ kple phone la',
      ga: 'Nyiɛ phone lɛ sɛɛ',
      ha: 'Bi wayar');
  static String get light =>
      _l('Light', tw: 'Hann', ee: 'Kekeli', ga: 'La', ha: 'Haske');
  static String get dark =>
      _l('Dark', tw: 'Sum', ee: 'Viviti', ga: 'Duŋ', ha: 'Duhu');
  ...
  static String get voices => _l('Voices',
      tw: 'Nne ahorow', ee: 'Gbeawo', ga: 'Gbeei', ha: 'Muryoyi');
  static String get voicesBlurb => _l(
      ...
      ga: 'Download gbee lɛ ni akane gbɛtsɔɔmɔ lɛ yɛ owiemɔ mli. Shikome pɛ.',
  ...
  static String voiceBlurb(String language) => _l(
      ...
      ga: 'Ekaneɔ $language gbɛtsɔɔmɔ, internet he ehiaaa.',
  ...
  static String get remove => _l('Remove',
      tw: 'Yi fi hɔ', ee: 'Ɖee ɖa', ga: 'Jiemɔ', ha: 'Cire');
  static String get installed => _l('Installed',
      tw: 'Ɛwɔ hɔ', ee: 'Ele afi ma', ga: 'Eyɛ mli', ha: 'An sauke');
  ...
  static String get fromRegisterTag => _l('register',
      tw: 'nhoma mu', ee: 'agbalẽ me', ga: 'wolo mli', ha: 'rijista');
  ...
  static String get sideFailed => _l(
      ...
      ga: 'Anyɛɛɛ fã nɛɛ akane. Klɛŋklɛŋ hetoo lɛ yɛ mli lolo.',
  ...
  static String get about => _l('About',
      tw: 'Ɛfa ho', ee: 'Tso eŋu', ga: 'Ehe sane', ha: 'Game da shi');
  static String snapshotLine(int count, String date) => _l(
      ...
      ga: 'FDA wolo mli nibii: $count · $date',
  ...
  static String get disclaimer => _l(
      ...
      ga: 'Aduro Guard buaa bo ni okwɛɔ tsofa; jeee tsofayeli he ŋaawoo. Kɛji hela sane ko yɛ lɛ, yaa pharmacist, clinic, loo FDA ŋɔɔ yɛ 0551112224 (WhatsApp) nɔ.',
  ...
  static String get welcomeBlurb => _l(
      ...
      ga: 'Kɛ o-camera tsɔɔ tsofa adeka fɛɛ nɔ. Akɛtoɔ Ghana FDA wolo lɛ he yɛ o-phone nɔ; internet he ehiaaa.',
